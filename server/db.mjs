import { reconcileAlerts } from './notifications.mjs';
...
export async function checkSchema(pool) {
  ...
  if (versions[0]?.version !== 1) throw Object.assign(new Error('Versión de base incompatible. Revisa las migraciones y la versión de la app.'), { code: 'SCHEMA_VERSION' });
